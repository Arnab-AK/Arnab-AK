...
SDE2 with 4.5+ years building backend services and distributed data platforms using **Python**, **Apache Spark**, and **GenAI** technologies — currently at **Visa Inc.** as a Software Development Engineer II, designing and optimizing production systems that process millions of transactions daily.
...
<img src="./assets/header-wave.svg" alt="" width="100%" style="transform: scaleY(-1);" />
